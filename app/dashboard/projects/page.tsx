...
import { ArrowRight, Clock, TrendingUp, Target, Loader2 } from "lucide-react"
...
export default function MyProjects() {
  ...
  const { user } = useAuth() // Si vous avez un contexte d'authentification
  ...
  try {
    ...
    // Supprimez le "/api" au début car useApi l'ajoute automatiquement
    ...
    const response = await fetchApi(endpoint, {
      ...
      if (response.success && Array.isArray(response.data?.projects)) {
        // Si votre API retourne { data: { projects: [...] } }
        ...
        // Si votre API retourne juste un tableau
      ...
      setProjects([]) // Vide les projets en cas d'erreur
    } finally {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                {formatCurrency(projects.reduce((sum, p) => sum + p.invested, 0))} €
              </p>
            </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                {formatCurrency(projects.reduce((sum, p) => sum + p.returns, 0))} €
              </p>
            </div>
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button
                      onClick={() => {/* Logique pour mettre à jour l'investissement */}}
